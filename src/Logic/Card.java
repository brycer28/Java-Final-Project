...
public class Card {
    ...
    public String getImgPath() {
        ...
        String r=null;
        if (rank == Rank.TWO) {r = "2";}
        else if (rank == Rank.THREE) {r = "3";}
        else if (rank == Rank.FOUR) {r = "4";}
        else if (rank == Rank.FIVE) {r = "5";}
        else if (rank == Rank.SIX) {r = "6";}
        else if (rank == Rank.SEVEN) {r = "7";}
        else if (rank == Rank.EIGHT) {r = "8";}
        else if (rank == Rank.NINE) {r = "9";}
        else if (rank == Rank.TEN) {r = "10";}
        else if (rank == Rank.JACK) {r = "j";}
        else if (rank == Rank.QUEEN) {r = "q";}
        else if (rank == Rank.KING) {r = "k";}
        else if (rank == Rank.ACE) {r = "a";}
