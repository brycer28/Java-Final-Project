...
public class CrazyEightsPanel extends JPanel {
    ...
    public CrazyEightsPanel() {
        ...
        // playedPilePanel.setBounds(350, 200, playedPilePanel.getWidth(),
        // playedPilePanel.getHeight());
    ...
    private void makeFaceUp(CardPanel panel) {
    ...
    private void updateCardPanels() {
        ...
        if (playedPilePanel != null)
            remove(playedPilePanel);
        playedPilePanel = new CardPanel(gameLogic.getTopDiscardCard(), 80);
        makeFaceUp(playedPilePanel);
        add(playedPilePanel);
    ...
    // This method puts mouse listeners on the card panels to be played by user by
    // clicking them
